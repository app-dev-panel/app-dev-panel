...
Каждый адаптер автоматически подтягивает [`app-dev-panel/kernel`](https://packagist.org/packages/app-dev-panel/kernel) и [`app-dev-panel/api`](https://packagist.org/packages/app-dev-panel/api) как зависимости.
