...
Собирает операции очереди сообщений — отправленные сообщения, статус обработки, ошибки и обнаружение дубликатов.
...
| `statuses` | Обновления статуса сообщений (ID и статус) |
...
| `failedCount` | Количество неудачных сообщений |
...
- **Symfony**: мидлвар Messenger и слушатели событий
...
- **Обнаружение дубликатов** — подсвечивает повторяющиеся идентичные сообщения
