...
Захватывает вызовы методов сервисов DI-контейнера — вызванный сервис, метод, аргументы, результат и тайминг.
...
| `timeEnd` | Время окончания вызова |
...
- **Список вызовов сервисов** — все отслеживаемые вызовы методов с классом, методом и таймингом
- **Раскрываемые детали** — аргументы и возвращаемые значения
- **Индикаторы статуса** — бейджи успеха (зелёный) и ошибки (красный)
