---
title: Тулбар
description: "Тулбар ADP встраивается в страницы приложения, показывая метрики запроса, количество логов и быстрый доступ."
---
...
- **Независимость от точки монтирования** — Iframe загружает HTML панели с `panel.viewer_base_path`; этот HTML содержит `<base href="<mount>/">`, поэтому встроенная панель и её прямые ссылки работают при монтировании на `/debug`, `/tools/debug` или любом другом префиксе (issue #113)
