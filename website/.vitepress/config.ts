...
export default defineConfig({
  ...
  title: "ADP",
  description:
    "Application Development Panel — framework-agnostic debugging and development panel",
  base: "/app-dev-panel/",
  head: [
    [
      "link",
      { rel: "icon", type: "image/svg+xml", href: "/app-dev-panel/duck.svg" },
    ],
    ...
    [
      "meta",
      {
        ...
        content: "ADP — Application Development Panel",
      },
    ],
    [
      "meta",
      {
        property: "og:image",
        content: "https://app-dev-panel.github.io/app-dev-panel/og-image.png",
      },
    ],
    [
      "meta",
      {
        property: "og:url",
        content: "https://app-dev-panel.github.io/app-dev-panel/",
      },
    ],
  ...
  locales: {
    root: {
      ...
      themeConfig: {
          ...
          "/guide/": [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "Elasticsearch",
                  link: "/guide/collectors/elasticsearch",
                },
                {
                  text: "OpenTelemetry",
                  link: "/guide/collectors/opentelemetry",
                },
                {
                  text: "Authorization",
                  link: "/guide/collectors/authorization",
                },
                ...
                {
                  text: "ConsoleAppInfo",
                  link: "/guide/collectors/console-app-info",
                },
                {
                  text: "Filesystem Stream",
                  link: "/guide/collectors/filesystem-stream",
                },
        ...
        editLink: {
          pattern:
            "https://github.com/app-dev-panel/app-dev-panel/edit/master/website/:path",
          ...
          "/ru/guide/": [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "Безопасность и авторизация",
                  link: "/ru/guide/security",
                },
                {
                  text: "Матрица возможностей",
                  link: "/ru/guide/feature-matrix",
                },
              ],
            },
            {
              ...
              items: [
                ...
                {
                  text: "HTTP Client",
                  link: "/ru/guide/collectors/http-client",
                },
                ...
                {
                  text: "Environment",
                  link: "/ru/guide/collectors/environment",
                },
                {
                  text: "Elasticsearch",
                  link: "/ru/guide/collectors/elasticsearch",
                },
                {
                  text: "OpenTelemetry",
                  link: "/ru/guide/collectors/opentelemetry",
                },
                {
                  text: "Authorization",
                  link: "/ru/guide/collectors/authorization",
                },
                {
                  text: "Deprecation",
                  link: "/ru/guide/collectors/deprecation",
                },
                ...
                {
                  text: "AssetBundle",
                  link: "/ru/guide/collectors/asset-bundle",
                },
                {
                  text: "WebAppInfo",
                  link: "/ru/guide/collectors/web-app-info",
                },
                { text: "Command", link: "/ru/guide/collectors/command" },
                {
                  text: "ConsoleAppInfo",
                  link: "/ru/guide/collectors/console-app-info",
                },
                {
                  text: "Filesystem Stream",
                  link: "/ru/guide/collectors/filesystem-stream",
                },
                {
                  text: "HTTP Stream",
                  link: "/ru/guide/collectors/http-stream",
                },
              ],
            },
            {
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "Playground-приложения",
                  link: "/ru/guide/playgrounds",
                },
                { text: "CI и инструменты", link: "/ru/guide/ci-and-tooling" },
                { text: "Скриншоты", link: "/ru/guide/screenshots" },
                {
                  text: "Интеграция с редакторами",
                  link: "/ru/guide/editor-integration",
                },
                { text: "llms.txt", link: "/ru/guide/llms-txt" },
                {
                  text: "Участие в разработке",
                  link: "/ru/guide/contributing",
                },
              ],
            },
          ],
