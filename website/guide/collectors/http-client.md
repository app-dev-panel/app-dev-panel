...
The collector is fed by `ClientInterfaceProxy` — a PSR-18 `ClientInterface` decorator. Every `$client->sendRequest($request)` call is automatically intercepted, timed, and recorded.
