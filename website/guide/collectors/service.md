...
The collector is fed by <class>\AppDevPanel\Adapter\Yiisoft\Proxy\ContainerInterfaceProxy</class> which wraps the PSR-11 <class>Psr\Container\ContainerInterface</class>. When services are resolved and their methods are called through the proxy, the calls are intercepted and recorded.
