...
[[issues]]
file = "src/Controller/TestFixtures/ElasticsearchAction.php"
code = "invalid-method-access"
...
file = "src/Controller/TestFixtures/HttpClientAction.php"
code = "invalid-method-access"
message = 'Attempting to access a method on a non-object type (`unknown-ref(Symfony\Component\HttpFoundation\RequestStack)`).'
count = 1
...
file = "src/Controller/TestFixtures/HttpClientAction.php"
code = "non-existent-class-like"
message = 'Cannot find class, interface, enum, or type alias `Symfony\Component\HttpFoundation\RequestStack`.'
count = 1
...
[[issues]]
file = "src/Controller/TestFixtures/RedisAction.php"
code = "invalid-method-access"
...
[[issues]]
file = "src/Controller/TestFixtures/ResetCliAction.php"
code = "impossible-assignment"
message = "Invalid assignment: the right-hand side has type `never` and cannot produce a value."
count = 1
...
file = "src/Controller/TestFixtures/ResetCliAction.php"
code = "invalid-method-access"
message = 'Attempting to access a method on a non-object type (`unknown-ref(Symfony\Component\HttpKernel\KernelInterface)`).'
count = 1
...
file = "src/Controller/TestFixtures/ResetCliAction.php"
code = "non-existent-class"
message = 'Class `Symfony\Component\Process\Process` not found.'
count = 1
...
file = "src/Controller/TestFixtures/ResetCliAction.php"
code = "non-existent-class-like"
message = 'Cannot find class, interface, enum, or type alias `Symfony\Component\HttpKernel\KernelInterface`.'
count = 1
...
code = "invalid-method-access"
message = 'Attempting to access a method on a non-object type (`unknown-ref(Symfony\Contracts\Translation\TranslatorInterface)`).'
count = 4
...
file = "src/Controller/TestFixtures/TranslatorAction.php"
code = "non-existent-class-like"
message = 'Cannot find class, interface, enum, or type alias `Symfony\Contracts\Translation\TranslatorInterface`.'
count = 1
