...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-control { width: 100%; padding: 9px 12px; font-size: 14px; font-family: var(--font); border: 1px solid var(--color-border); border-radius: var(--radius); background: var(--color-surface); color: var(--color-text); transition: border-color 0.15s, box-shadow 0.15s; }
    ...
    textarea.form-control { resize: vertical; min-height: 100px; font-family: var(--font-mono); font-size: 13px; }
    ...
    .btn { display: inline-flex; align-items: center; gap: 6px; padding: 9px 18px; font-size: 14px; font-weight: 500; font-family: var(--font); border: 1px solid transparent; border-radius: var(--radius); cursor: pointer; transition: background 0.15s, box-shadow 0.15s; text-decoration: none; }
    ...
    .btn-outline:hover { background: var(--color-badge-bg); border-color: var(--color-primary); }
    .btn-danger { background: var(--color-error); color: #fff; }
    .btn-danger:hover { background: #b91c1c; }
    .badge { display: inline-block; padding: 2px 8px; font-size: 11px; font-weight: 600; border-radius: 4px; text-transform: uppercase; letter-spacing: 0.3px; }
    ...
    .api-playground-row { display: flex; gap: 12px; align-items: flex-start; }
    .api-playground-row select { padding: 9px 12px; font-size: 14px; font-family: var(--font); border: 1px solid var(--color-border); border-radius: var(--radius); background: var(--color-surface); min-width: 200px; }
    .api-playground-row select:focus { outline: none; border-color: var(--color-primary); }
    .response-status { display: inline-flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; margin-bottom: 8px; }
...
<div class="header">
    <a href="/" class="header-brand">ADP Playground <span class="badge">Yii 3</span></a>
    <nav>
        <a href="/"<?= $currentPath === '/' ? ' class="active"' : '' ?>>Home</a>
        <a href="/users"<?= $currentPath === '/users' ? ' class="active"' : '' ?>>Users</a>
...
<div class="footer">
    ADP Playground — Yii 3 | Powered by <a href="https://github.com/app-dev-panel">Application Development Panel</a>
</div>
