...
- **Direct collector injection via Module** — `CacheAction`, `DatabaseAction`, `MailerAction`, `DumpAction` access collectors via `\Yii::$app->getModule('app-dev-panel')->getCollector()`
