 ...
 * Composer package under `/vendor/app-dev-panel/{file}`. No `vendor:publish` needed.
 *
 * Streams files directly from the Composer install directory. Returns 404 for any
 * path that resolves outside of `FrontendAssets::path()` (path-traversal guard).
 */
