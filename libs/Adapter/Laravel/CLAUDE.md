...
| `Illuminate\Auth\Events\Authenticated` | `AuthorizationCollector` | User identity + guard (session-based) |
| `Illuminate\Auth\Events\Login` | `AuthorizationCollector` | Login auth event + user identity |
| `Illuminate\Auth\Events\Logout` | `AuthorizationCollector` | Logout auth event |
| `Illuminate\Auth\Events\Failed` | `AuthorizationCollector` | Failed auth event |
| `Illuminate\Auth\Events\OtherDeviceLogout` | `AuthorizationCollector` | Other device logout event |
