...
final class ConnectionInterfaceProxy implements ConnectionInterface
{
    ...
    {
        return new TransactionInterfaceDecorator($this->connection->createTransaction(), $this->collector);
    }
    ...
    public function getTransaction(): ?TransactionInterface
    {
        ...
        return $result === null ? null : new TransactionInterfaceDecorator($result, $this->collector);
    }
