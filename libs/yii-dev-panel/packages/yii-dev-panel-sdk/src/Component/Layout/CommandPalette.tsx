...
const defaultPages: PaletteItem[] = [
    ...
    {icon: 'alt_route', label: 'Inspector > Routes', path: '/inspector/routes', shortcut: '/routes', section: 'Pages'},
    {
        icon: 'settings',
    ...
    {
        icon: 'storage',
        label: 'Inspector > Database',
        path: '/inspector/database',
        shortcut: '/database',
        section: 'Pages',
    },
    {
        icon: 'inventory_2',
        label: 'Inspector > Container',
        path: '/inspector/container/view',
        shortcut: '/container',
        section: 'Pages',
    },
    {
    ...
    {icon: 'source', label: 'Inspector > Git', path: '/inspector/git', shortcut: '/git', section: 'Pages'},
    {icon: 'info', label: 'Inspector > PHP Info', path: '/inspector/phpinfo', shortcut: '/phpinfo', section: 'Pages'},
    {
        icon: 'extension',
        label: 'Inspector > Composer',
        path: '/inspector/composer',
        shortcut: '/composer',
        section: 'Pages',
    },
    {icon: 'speed', label: 'Inspector > OPcache', path: '/inspector/opcache', shortcut: '/opcache', section: 'Pages'},
    {icon: 'cached', label: 'Inspector > Cache', path: '/inspector/cache', shortcut: '/cache', section: 'Pages'},
    {icon: 'code', label: 'Gii', path: '/gii', shortcut: '/gii', section: 'Pages'},
    {icon: 'api', label: 'OpenAPI', path: '/open-api', shortcut: '/openapi', section: 'Pages'},
];
