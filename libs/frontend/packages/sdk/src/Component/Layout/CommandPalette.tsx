...
const defaultPages: PaletteItem[] = [
    ...
    },
    {
        ...
        path: '/inspector/routes',
        shortcut: '/routes',
        section: 'Inspector',
    },
    {
        icon: 'verified',
        label: 'Inspector > Code Quality',
        path: '/inspector/code-quality',
        shortcut: '/quality',
        section: 'Inspector',
    },
    {
        icon: 'science',
        label: 'Inspector > Code Quality > Tests',
        path: '/inspector/code-quality?tab=tests',
        shortcut: '/tests',
        section: 'Inspector',
    },
    {
        icon: 'analytics',
        label: 'Inspector > Code Quality > Analyse',
        path: '/inspector/code-quality?tab=analyse',
        shortcut: '/analyse',
        section: 'Inspector',
    },
    {
        icon: 'shield',
        label: 'Inspector > Code Quality > Coverage',
        path: '/inspector/code-quality?tab=coverage',
        shortcut: '/coverage',
        section: 'Inspector',
    },
    {
        icon: 'folder_open',
        label: 'Inspector > File Explorer',
    ...
    {
        icon: 'translate',
        label: 'Inspector > Translations',
        path: '/inspector/translations',
        shortcut: '/i18n',
        section: 'Inspector',
    },
    {
        ...
        path: '/inspector/commands',
        shortcut: '/commands',
        section: 'Inspector',
    },
    {
        icon: 'storage',
        label: 'Inspector > Storage',
        path: '/inspector/storage',
        shortcut: '/storage',
        section: 'Inspector',
    },
    {
        icon: 'storage',
        label: 'Inspector > Storage > Database',
        path: '/inspector/storage?tab=database',
        shortcut: '/database',
        section: 'Inspector',
    },
    {
        icon: 'cached',
        label: 'Inspector > Storage > Cache',
        path: '/inspector/storage?tab=cache',
        shortcut: '/cache',
        section: 'Inspector',
    },
    {
        icon: 'memory',
        label: 'Inspector > Storage > Redis',
        path: '/inspector/storage?tab=redis',
        shortcut: '/redis',
        section: 'Inspector',
    },
    {
        icon: 'search',
        label: 'Inspector > Storage > Elasticsearch',
        path: '/inspector/storage?tab=elasticsearch',
        shortcut: '/elasticsearch',
        section: 'Inspector',
    },
    {
        icon: 'shield',
        label: 'Inspector > Authorization',
        path: '/inspector/authorization',
        shortcut: '/auth',
        section: 'Inspector',
    },
    {
        icon: 'settings_suggest',
        label: 'Inspector > Environment',
        path: '/inspector/environment',
        shortcut: '/env',
        section: 'Inspector',
    },
    {
        icon: 'info',
        label: 'Inspector > Environment > PHP Info',
        path: '/inspector/environment?tab=phpinfo',
        shortcut: '/phpinfo',
        section: 'Inspector',
    },
    {
        icon: 'inventory_2',
        label: 'Inspector > Environment > Composer',
        path: '/inspector/environment?tab=composer',
        shortcut: '/composer',
        section: 'Inspector',
    },
    {
        icon: 'speed',
        label: 'Inspector > Environment > Opcache',
        path: '/inspector/environment?tab=opcache',
        shortcut: '/opcache',
        section: 'Inspector',
    },
    {
        icon: 'code',
        label: 'Inspector > Environment > Git',
        path: '/inspector/environment?tab=git',
        shortcut: '/git',
        section: 'Inspector',
    },
