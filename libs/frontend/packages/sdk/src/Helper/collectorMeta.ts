...
const collectorMetaMap: Record<string, CollectorMeta> = {
    ...
    [CollectorsMap.FilesystemStreamCollector]: {label: 'I/O', icon: 'swap_horiz', weight: 11},
    [CollectorsMap.HttpClientCollector]: {label: 'HTTP', icon: 'cloud', weight: 12},
    ...
    [CollectorsMap.TemplateCollector]: {label: 'Template', icon: 'code', weight: 16},
    [CollectorsMap.AuthorizationCollector]: {label: 'Authorization', icon: 'shield', weight: 15},
