...
import {useBreadcrumbsContext} from '@app-dev-panel/panel/Application/Context/BreadcrumbsContext';
...
const repositoryUrl = 'https://github.com/app-dev-panel/app-dev-panel';
