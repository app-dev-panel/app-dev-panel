...
This feature allows you to create custom panels for the `app-dev-panel` and render them as native components.

### How to test

First of all, you need to serve the `app-dev-panel`.

Open a terminal and run:
```sh
cd packages/app-dev-panel; npm start
```
It serves the app-dev-panel project on `127.0.0.1:3000`. 
...
Then open the file `packages/app-dev-panel-sdk/src/Pages/Layout.tsx` and apply the following changes:
```diff
